...
const Network = () => {
  const networkOptions = [Networks.Polygon, Networks.Sepolia, Networks.Goerli, Networks.Optimism];
  const [isOpen, setIsOpen] = useState(false);
  const [network, setNetwork] = useState(localStorage.getItem('network') || Networks.Polygon);
