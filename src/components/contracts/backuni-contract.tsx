...
const BackuniContract = () => {
  ...
  return (
    <div className="wallet-method-container">
      ...
      {newUserError ? <ErrorText>You have to create a user first</ErrorText> : null}
      {storedUser?.userBalance == 0 ? <ErrorText>You didn't send tokens to this Uni as a Funder</ErrorText> : null}
      ...
      {newUserError ? <ErrorText>You have to create a user first</ErrorText> : null}
      {storedOrg?.orgBalance == 0 ? <ErrorText>You didn't send tokens to this Uni as an Admin</ErrorText> : null}
...
export default BackuniContract;